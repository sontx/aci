...
async def invite_user(
    ...
    logger.info(
        ...
        f"to organization with org_id={context.org_id}, "
...
async def remove_user(
    ...
    logger.info(
        ...
        f"from organization with org_id={context.org_id}, "
        f"user_id={context.user.user_id}"
    )
    ...
    if user_id == context.user.user_id:
        ...
        org_member_info = context.user.org_id_to_org_member_info.get(str(context.org_id))
...
async def list_users(
    ...
    """
    logger.info(f"Listing organization users with org_id={context.org_id}, user_id={context.user.user_id}")
    ...
    for org_user in users_paged.users:
        ...
        org_info = org_user.org_id_to_org_info.get(str(context.org_id), {})
