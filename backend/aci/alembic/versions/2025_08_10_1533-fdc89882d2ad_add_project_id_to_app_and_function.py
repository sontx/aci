"""add project id to app and function

Revision ID: fdc89882d2ad
Revises: 7aff29612b03
Create Date: 2025-08-10 15:33:22.826332+00:00
...
def upgrade() -> None:
    ...
    op.add_column('apps', sa.Column('project_id', sa.UUID(), nullable=True))
    ...
    op.add_column('functions', sa.Column('project_id', sa.UUID(), nullable=True))
    ...
    op.create_index(op.f('ix_functions_project_id'), 'functions', ['project_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_column('apps', 'project_id')
    # ### end Alembic commands ###
